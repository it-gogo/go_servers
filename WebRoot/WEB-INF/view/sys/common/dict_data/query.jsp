			...
			**/
			$('#dg').datagrid({  
			    ...
			    columns:[[  
			        ...
			        {field:'name',title:'数据字典数据名称',width:200},  
			        {field:'checked',title:'是否默认',width:200,align:'left',formatter:function(value,row,index){
			        	if(value == 1){
			        ...
			        {field:'create_time',title:'创建时间',width:200,align:'left'},
			        {field:'update_time',title:'修改时间',width:200,align:'left'},
			        {field:'remarks',title:'备注说明',width:200,align:'left'}
			    ]]  
			}); 
