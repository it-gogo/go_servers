	    	...
	    	<table width="96%" class="t2">
	    		...
	    		<tr>
					...
					<tr>
						...
						<td><input class="easyui-validatebox" type="text" name="seq" id="seq" style="width:410px;" class="easyui-validatebox" data-options="required:true,validType:'isNumber[8]'" /></td>
					</tr>
	    		<tr>
