...
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
	<jsp:include page="/WEB-INF/view/client/login/common/head.jsp" >
    	<jsp:param value="我的详单" name="name"/>
	 </jsp:include>
</head>
<body>
...
<div id="content_container">
  ...
  <div id="content_left">
    <h1>客户区</h1>
    <p class="breadcrumb"><a href="../index/index.htm">门户主页</a> > <a href="../index/customerArea.htm">客户区</a> > <a href="../portal/myDetail.htm">我的详细信息</a></p>
 ...
 <!--  <br />
  <table width="100%" cellspacing="0" cellpadding="0" class="frame">
    <tr>
      <td><table width="100%" border="0" cellpadding="10" cellspacing="0">
          <tr>
            <td width="150" class="fieldarea">付款方式</td>
            <td><select name="paymentmethod">
                <option value="none">默认（每单设置）</option>
                <option value="alipay">支付宝</option>
                <option value="paypal">PayPal</option>
              </select></td>
          </tr>
          <tr>
            <td width="150" class="fieldarea">默认账单联系方式</td>
            <td><select name="billingcid">
                <option value="0">使用默认联系（参考上方详情）</option>
              </select></td>
          </tr>
                </table></td>
    </tr>
