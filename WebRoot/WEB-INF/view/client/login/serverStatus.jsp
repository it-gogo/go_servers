...
<jsp:include page="/WEB-INF/view/client/login/common/head.jsp" >
    	<jsp:param value="服务器状态" name="name"/>
	 </jsp:include>
</head>
<body>
...
<div id="content_container">
  <div id="content_left">
    <h1>服务器状态</h1>
    <p class="breadcrumb"><a href="index.php">门户主页</a> > <a href="serverstatus.php">服务器状态</a></p><p>登录访问，该登录信息区别于您的网站控制面板用户名和密码。</p>
...
<div align="right"><form method="post" action="/whmcs/serverstatus.php" name="languagefrm" id="languagefrm">
