...
<div id="side_menu">
    ...
    <ul>
     ...
     <%--  <li><a href="download.htm" title="下载"><img src="<%=request.getContextPath() %>/client/loginCss/images/downloads.gif" alt="下载" width="16" height="16" border="0" class="absmiddle" /></a> <a href="download.htm" title="下载">下载</a></li> --%>
      <li><a href="../../../client/main/public.htm" title="订单"><img src="<%=request.getContextPath() %>/client/loginCss/images/order.gif" alt="订单" width="16" height="16" border="0" class="absmiddle" /></a> <a href="../../../client/main/public.htm" title="订单">订单</a></li>
    </ul>
